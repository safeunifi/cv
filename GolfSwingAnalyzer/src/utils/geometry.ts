/**
 * Geometry helpers for calculating joint angles from pose data
 */
...
/** Calculate angle between three points (in degrees), with b as the vertex */
...
/** Calculate angle from the vertical axis (in degrees) */
...
/** Ideal angle ranges for swing evaluation */
...
/** Evaluate an angle value against the ideal range for a given phase */
